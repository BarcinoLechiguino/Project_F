...
Scene1::Scene1() : Scene(SCENES::FIRST_SCENE)
{
	name_tag = ("scene");
}
...
void Scene1::LoadGuiElements()
{
	...
	button_text = (UI_Text*)App->gui->CreateText(UI_Element::TEXT, 200, 689, text_rect, font, SDL_Color{ 255, 255, 255, 255 }, true, false, false, nullptr, transition_button, &button_string);
...
void Scene1::OnEventCall(UI* element, UI_Event ui_event)
{
	...
	{
		App->transition_manager->CreateAlternatingBars(SCENES::MAIN_MENU, 0.5f, true, 5, true, true);
	}
}
